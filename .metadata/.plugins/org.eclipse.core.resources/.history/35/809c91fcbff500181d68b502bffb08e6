...
public class CollegeDatabase implements Database{
	...
	public CollegeDatabase byGPA(double GPA, String operator) {
	...
	public CollegeDatabase bySalary(double salary, String operator) {
		Person[] inRange = new Person[size];
		int count = 0;
		for (int i = 0; i < size; i++) {
			if (operator.equals("over")){
	 ...
	 **************************************************************************/
	public CollegeDatabase separate(int age, String operator) throws IllegalArgumentException{ //when .print() used, null to string error FIXME
		Person[] inRange = new Person[size];
		int count = 0;
		for (int i = 0; i < size; i++) {
			if (operator.equals("over")){
