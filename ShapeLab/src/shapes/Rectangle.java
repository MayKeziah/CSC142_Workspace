...
public class Rectangle extends Shape{
	 ...
	 ************************************************************************/
	public double area() {
		return super.hundreth(height * width);
	}
	...
	public double getHeight() {
		return super.hundreth(height);
	}
	public double getWidth() {
		return super.hundreth(width);
	}
	...
	public double perimeter() {
		return super.hundreth(2 * (height + width));	
	}
	...
	public String toString() {
		return "(" + super.df.format(height) + ", " + super.df.format(width) + ")";
	}
}